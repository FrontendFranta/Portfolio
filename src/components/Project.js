            ...
            <div className='col-lg-4'>
              <Fade left>
                <div className=' py-5'>
                   ...
                   <h3>TRVL.</h3>
                    <p className='clear-text'>Vymyšlená responzivní webová stránka, která obsahuje View more, vlastní text/image slider pomocí useState, pohyblivé animace, hamburger menu, filter items</p>
