  ...
  return (
   <nav className={header ? 'navbar navbar-expand-lg scroll fixed-top':'navbar navbar-expand-lg  fixed-top'}>
    <div className='container'>
        <a className='navbar-brand' href='https://FrontendFranta.github.io/Portfolio'>FrantaFajna <FaTypo3/> </a>
        
        <div className='menu-icon' onClick={handleClick}>
            {click? <FaRegTimesCircle/>:<FaBars/>}
        </div>
        <div className={click?'navbar-nav active':'navbar-nav'}>
        <a className='nav-link' href='https://FrontendFranta.github.io/Portfolio' onClick={closeMobileMenu}>Úvod</a>
